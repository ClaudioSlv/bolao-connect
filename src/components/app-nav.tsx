...
type NavItem = {
  href: string;
  label: string;
  icon: "home" | "people" | "wallet" | "games" | "menu";
};
...
function NavIcon({ name }: { name: NavItem["icon"] }) {
  ...
  if (name === "people")
    return (
      <svg {...common}>
        ...
        <path d="M16 14.2a4.5 4.5 0 0 1 4.5 4.5V20" />
      </svg>
    );
  if (name === "wallet")
    return (
      <svg {...common}>
        ...
        <circle cx="15.5" cy="13" r=".5" fill="currentColor" stroke="none" />
      </svg>
    );
  if (name === "menu")
    return (
  ...
  return (
    <svg {...common}>
      <path d="M5 4h14a2 2 0 0 1 2 2v4a2.5 2.5 0 0 0 0 5v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-3a2.5 2.5 0 0 0 0-5V6a2 2 0 0 1 2-2Z" />
