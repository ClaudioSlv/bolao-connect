...
type NavItem = {
  href: string;
  label: string;
  icon: "home" | "people" | "wallet" | "games" | "test";
};
...
const items: NavItem[] = [
  ...
  {href: "/teste-pagamento", label: "Teste", icon: "test"},
];
...
function NavIcon({name}: {name: NavItem["icon"]}) {
  ...
  if (name === "test") return <svg {...common}><path d="M9 3h6M10 3v5l-5 9a3 3 0 0 0 2.6 4.5h8.8A3 3 0 0 0 19 17l-5-9V3"/><path d="M7.5 16h9"/></svg>;
