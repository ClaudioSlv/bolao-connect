...
export async function GET(req:Request){
  ...
  let sent=0,disabled=0,skipped=0,timerSent=0,timerDisabled=0,timerSkipped=0;
  const now=Date.now();
  ...
  return NextResponse.json({ok:true,sent,disabled,skipped,timerSent,timerDisabled,timerSkipped,timerTableReady:!timerError});
}
