  ...
  return (
    <main className="shell receipt-page">
      ...
      <section className="section">
        ...
        <p className="muted">
          Toque na foto, amplie com dois dedos e arraste para conferir o bilhete
          inteiro.
        </p>
      </section>
      <section className="section">
        {!groups.length ? (
          <div className="card">
            <strong>Aguardando publicação</strong>
            <span>O organizador ainda não publicou os bilhetes.</span>
          </div>
        ) : (
